...
DOWNLOADER_MIDDLEWARES = {
   ...
   "WebScraper.middlewares.RandomUserAgentMiddleware": 543,
   "WebScraper.middlewares.LianjiaProxyMiddleware": 543,
}
...
ITEM_PIPELINES = {
    'WebScraper.pipelines.LianjiaPipeline': 300, # 爬取房源的管道
    'WebScraper.pipelines.URLPipeline': 300, # 爬取url的管道
}
